...
describe('MovieDetailComponent', () => {
  ...
  it('should set imageUrls and poster paths in setImageUrl method', () => {
    ...
    expect(component.imageUrls).toBe(`${HttpUrl.baseImageUrl}/${HttpUrl.imageResource}/w1920_and_h600_multi_faces_filter(duotone,00192f,00baff)/${response.backdrop_path}`);
